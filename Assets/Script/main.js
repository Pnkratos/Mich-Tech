...
lugarTitulo.innerHTML = `<a href='smartphones.html'><h1 class='titsec' id='titsec1'>SMARTPHONES <img src='./Assets/botoes/flechaD.svg'></h1></a>`;
...
lugarTitulo.innerHTML = `<a href='informatica.html'><h1 class='titsec' id='titsec2'>INFORMÁTICA <img src='./Assets/botoes/flechaD.svg'></h1></a>`;
...
lugarTitulo.innerHTML = `<a href='Tv.html'><h1 class='titsec' id='titsec3'>SMART TV <img src='./Assets/botoes/flechaD.svg'></h1></a>`;
...
lugarTitulo.innerHTML = `<a href='Casa Inteligente.html'><h1 class='titsec' id='titsec4'>Casa Inteligente <img src='./Assets/botoes/flechaD.svg'></h1></a>`;
...
for(const produtos of utilidades){
  ...
  function habilitarProdutoIndividual(id){
    ...
    if(produtos.cate == 'eletrodomestico'){
      produtos.cate = 'Casa Inteligente'
    }
...
function filtrarProdutos(){
  ...
  for(const prode of utilidades){
    var btnAbrirPesquisa = document.getElementById(`btnPesquisaProduto${prode.id}`)
    btnAbrirPesquisa.addEventListener("click",()=>aparecerProdutoIndividual(prode.id))
  }
}
filtrarProdutos()
