...
lugarTitulo.innerHTML = `<a href='Casa Inteligente.html' style='text-align:center;'><h1 id='titsec'>Casa Inteligente</h1><br><br><br></a>`;
...
function renderizarProduto() {
  ...
  const celulares = utilidades.filter(
    (produto) => produto.cate === "eletrodomestico"
  );
...
input.addEventListener("input", (event) => {
  ...
  const cateFiltrada = utilidades.filter((c)=>c.cate == 'eletrodomestico')
